...
# Initialize pygame before importing pygamegameasync
pygame.mixer.init(frequency=24000, size=-16, channels=2)
pygame.init()

# Add the current directory to the path so we can import pygamegameasync
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))

# Use the GameReplayer class from test_replay_simple.py instead
class GameReplayer:
